...
2. [Wiki — English](../../wiki/PUF_Model_EN.md): background, model rationale, model results, experimental comparisons and the next design round, with APA references.
3. [Wiki figures and captions](../../wiki/figures/captions.md): scaffold classification, S12 distributions, endpoint confusion matrices and non-TRM candidates.
...
The focused [scaffold page](../../wiki/PUF_Module1_EN.md) reproduces the current scaffold section. It links to the earlier detailed evaluation record. Use the full Wiki pages for the three-model narrative.
