...
In nested leave-one-identity-out validation on the **76 development constructs**,
the complete selection procedure achieved **48/76 (63.2%)**, **60.4% balanced
accuracy**, and **0.6042 macro F1**. The matched majority reference achieved
**50/76 (65.8%)** and **61.8% balanced accuracy**. This does **not** establish a
baseline advantage. Fold-specific biological thresholds vary from −2.5 to −20 pp.
