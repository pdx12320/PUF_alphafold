...
**[Read the complete model page →](PUF_Model_EN.md)**

The narrative follows biological background, model rationale, evaluation, experimental comparison and subsequent design decisions.
...
| [Figure gallery](figures/captions.md) | Figure captions, with archived C388 panels explicitly labelled |
