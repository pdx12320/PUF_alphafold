...
Run from any directory:
    python docs/wiki/scripts/make_figures.py

Optional extended layout QA:
    python docs/wiki/scripts/make_figures.py --qa-tools-dir /path/to/figure-qa/scripts
...
OUT = ROOT / "docs/wiki/figures"
DATA = ROOT / "docs/wiki/figure_data"
QA = OUT / "qa"
MM = 1 / 25.4
BLUE = "#287C9D"
ORANGE = "#C47742"
...
SOURCES = {
    "scaffold_metrics": "results_20260922/scaffold_RF/results/metrics.csv",
    "scaffold_predictions": "results_20260922/scaffold_RF/results/predictions_indexed.csv",
    "scaffold_labels": "results_20260922/scaffold_RF/results/construct_ids.csv",
    "five_construct_predictions": "results_20260922/five_construct_holdout/predictions.csv",
    "mpnn_site_scores": "aice_mpnn_20260922/results/aice_single_ranked.csv",
}
SOURCE_FRAMES = {}
